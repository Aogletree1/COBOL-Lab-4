       ...
       PROGRAM-ID. LAB4SINGLEBREAK.
       AUTHOR. AUSTIN OGLETREE.
      *************************
      *              LAB 4 - SINGLE LEVEL CONTROL BREAK AND
      *                      EVALUATE STATEMENTS
      *
      ...
      *
       ...
       FILE-CONTROL.
           SELECT CLASS-FILE
               ASSIGN TO 'L4CLASSLIST.TXT'
               ORGANIZATION IS LINE SEQUENTIAL.

           SELECT REPORT-FILE
               ASSIGN TO 'L4REPORT.TXT'.
      *
       DATA DIVISION.
       FILE SECTION.
      *
     ...
     *
      ...
      *
       01 HOLD-FIELD.
           ...
           05  CTRL-FIELD          PIC X(5)      VALUE SPACES.
      *
       01  DETAIL-FIELDS.
      ...
      * PUT EVALUATE STATEMENT TO CHECK FOR CONTROL BREAK
         ...
         EVALUATE TRUE
               WHEN FIRST-RECORD = 'Y'
                    MOVE CTRL-FIELD TO CLASS-HOLD
                    MOVE 'NO' TO FIRST-RECORD
               WHEN CTRL-FIELD NOT = CLASS-HOLD
      ...
      *  ADD THE 4 GRADES TOGETHER
         COMPUTE DF-SUM-GRADES = CF-GRADE1 + CF-GRADE2 +
                                 CF-GRADE3 + CF-GRADE4
      ...
      *  CALULATE THE AVERAGE
         ...
         COMPUTE DF-AVG = DF-SUM-GRADES / CF-NUM-TESTS
      ...
      * MOVE THE NEW INCOMING CLASS CODE TO THE CLASS HOLD
      ...
      * CALLING THE BREAK HERE FORCES THE LAST TOTAL LINE TO PRINT
